...
const createRestaurantDetailTemplate = (restaurant) => `
  ...
  <img class="restaurant__poster lazyload" data-src="${CONFIG.BASE_IMAGE_URL + restaurant.restaurant.pictureId}" alt="${restaurant.restaurant.name}" />
...
const createRestaurantItemTemplate = (restaurant) => `
    <div class="restaurant-item">
      ...
      <div class="restaurant-item__content">
        <h3 class="restaurant__title"><a class="restaurant__title" href="/#/detail/${restaurant.id}">${restaurant.name}</a></h3>
